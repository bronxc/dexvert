...
export class timexHiColor extends Format
{
	...
	unsupported = true;	// not even 1 valid file on discmaster and recoil2png seems to convert anything that is .scr and 12288 bytes which is exactly 12k which is more common than you'd think
}
